...
var TokenMetaData = &bind.MetaData{
	ABI: "[{\"type\":\"function\",\"name\":\"recharge_sol\",\"inputs\":[],\"outputs\":[{\"name\":\"\",\"type\":\"uint256\",\"components\":[]}],\"stateMutability\":\"payable\"},{\"type\":\"function\",\"name\":\"withdraw_sol\",\"inputs\":[{\"name\":\"user\",\"type\":\"address\",\"components\":[]},{\"name\":\"eth_amount\",\"type\":\"uint256\",\"components\":[]}],\"outputs\":[],\"stateMutability\":\"nonpayable\"},{\"type\":\"function\",\"name\":\"get_balance_sol\",\"inputs\":[{\"name\":\"user\",\"type\":\"address\",\"components\":[]}],\"outputs\":[{\"name\":\"\",\"type\":\"uint256\",\"components\":[]}],\"stateMutability\":\"view\"},{\"type\":\"function\",\"name\":\"to_points_sol\",\"inputs\":[{\"name\":\"eth_amount\",\"type\":\"uint256\",\"components\":[]}],\"outputs\":[{\"name\":\"\",\"type\":\"uint256\",\"components\":[]}],\"stateMutability\":\"view\"},{\"type\":\"function\",\"name\":\"get_rate_sol\",\"inputs\":[],\"outputs\":[{\"name\":\"\",\"type\":\"uint256\",\"components\":[]}],\"stateMutability\":\"view\"},{\"type\":\"function\",\"name\":\"owner_sol\",\"inputs\":[],\"outputs\":[{\"name\":\"\",\"type\":\"address\",\"components\":[]}],\"stateMutability\":\"view\"},{\"type\":\"fallback\",\"stateMutability\":\"payable\"}]",
}
...
//
// Solidity: function to_points_sol(uint256 eth_amount) view returns(uint256)
func (_Token *TokenCaller) ToPointsSol(opts *bind.CallOpts, eth_amount *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "to_points_sol", eth_amount)
...
//
// Solidity: function to_points_sol(uint256 eth_amount) view returns(uint256)
func (_Token *TokenSession) ToPointsSol(eth_amount *big.Int) (*big.Int, error) {
	return _Token.Contract.ToPointsSol(&_Token.CallOpts, eth_amount)
}

// ToPointsSol is a free data retrieval call binding the contract method 0x1c342812.
//
// Solidity: function to_points_sol(uint256 eth_amount) view returns(uint256)
func (_Token *TokenCallerSession) ToPointsSol(eth_amount *big.Int) (*big.Int, error) {
	return _Token.Contract.ToPointsSol(&_Token.CallOpts, eth_amount)
}
...
//
// Solidity: function withdraw_sol(address user, uint256 eth_amount) returns()
func (_Token *TokenTransactor) WithdrawSol(opts *bind.TransactOpts, user common.Address, eth_amount *big.Int) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "withdraw_sol", user, eth_amount)
}

// WithdrawSol is a paid mutator transaction binding the contract method 0xafde79c9.
//
// Solidity: function withdraw_sol(address user, uint256 eth_amount) returns()
func (_Token *TokenSession) WithdrawSol(user common.Address, eth_amount *big.Int) (*types.Transaction, error) {
	return _Token.Contract.WithdrawSol(&_Token.TransactOpts, user, eth_amount)
}

// WithdrawSol is a paid mutator transaction binding the contract method 0xafde79c9.
//
// Solidity: function withdraw_sol(address user, uint256 eth_amount) returns()
func (_Token *TokenTransactorSession) WithdrawSol(user common.Address, eth_amount *big.Int) (*types.Transaction, error) {
	return _Token.Contract.WithdrawSol(&_Token.TransactOpts, user, eth_amount)
}
